    ...
    public partial class İlk : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        SoruCevapID = c.Int(nullable: false, identity: true),
                        Soru = c.String(),
                        Cevap = c.String(),
                        Users_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.SoruCevapID)
                .ForeignKey("dbo.AspNetUsers", t => t.Users_Id)
                .Index(t => t.Users_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Uruns", "Users_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.SoruVeCevaps", "Users_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.Uruns", "KategoriID", "dbo.Kategoris");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.SoruVeCevaps", new[] { "Users_Id" });
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Uruns", new[] { "Users_Id" });
            DropIndex("dbo.Uruns", new[] { "KategoriID" });
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.SoruVeCevaps");
